...
public class DBConstants {
  ...
  //public static final String COUNT_PAID_TICKETS = "select count(*) from ticket where ......... ";
    public static final String COUNT_PAID_TICKETS = "select count(*) from ticket where VEHICLE_REG_NUMBER = ? and PRICE > 0";
}
